...
@Component({
  selector: 'app-appraisal-group-setting-dialog',
  templateUrl: './appraisal-group-setting-dialog.component.html',
  styleUrls: ['./appraisal-group-setting-dialog.component.scss']
})
export class AppraisalGroupSettingDialogComponent implements OnInit {
  type:any;
  appraisalForm: any;
  userData: any;
  yearData:any[];
  ...
  constructor(private fb: FormBuilder,private pasonaService:PasonaServiceService,public dialogRef: MatDialogRef<AppraisalGroupSettingDialogComponent>, @Inject(MAT_DIALOG_DATA) public data: any) { 

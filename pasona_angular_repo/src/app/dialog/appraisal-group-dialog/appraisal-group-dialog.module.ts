...
const routes: Routes = [
    {
        path     : '',
        component: AppraisalGroupDialogComponent,
    }
];

@NgModule({
    declarations: [
        AppraisalGroupDialogComponent
    ],
    entryComponents: [AppraisalGroupDialogComponent],
    imports     : [
        CommonModule,
...
export class AppraiserGroupDailogModule
{
}
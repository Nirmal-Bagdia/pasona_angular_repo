...
import { MatRadioModule, MatSliderModule, MatDialogModule, MatDatepickerModule, MatTabsModule, MatCheckboxModule } from '@angular/material';
...
export class EditGoalsModuleEmployee
{
}
